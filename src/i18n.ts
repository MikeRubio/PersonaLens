...
const resources = {
  en: {
    translation: {
      ...
      goBack: "Go back",
      apiKeySection: "PersonaLens API Key",
      apiKeyDescription:
      ...
      apiKeySteps: {
        step1: "1. Visit the PersonaLens API dashboard",
        step2: "2. Create a new secret key",
        step3: "3. Copy and paste it above",
      },
      openDashboard: "Open PersonaLens Dashboard",
      privacyNote:
        "Privacy: Your API key is stored locally in your browser and never shared. Page content is sent to PersonaLens for analysis only when you run tests.",
  ...
  es: {
    translation: {
      ...
      goBack: "Volver",
      apiKeySection: "Clave API de PersonaLens",
      apiKeyDescription:
      ...
      apiKeySteps: {
        step1: "1. Visite el panel de PersonaLens API",
        step2: "2. Cree una nueva clave secreta",
        step3: "3. Cópiela y péguela arriba",
      },
      openDashboard: "Abrir Panel de PersonaLens",
      privacyNote:
        "Privacidad: Su clave API se almacena localmente en su navegador y nunca se comparte. El contenido de la página se envía a PersonaLens para análisis solo cuando ejecuta pruebas.",
